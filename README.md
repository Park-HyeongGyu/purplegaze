...
## Motivation
Existing server management tools are too versatile to use for personal server management purposes. It takes too long to get used to them since they include so many features which are not required for me. So I made my own tool including only essential features.
